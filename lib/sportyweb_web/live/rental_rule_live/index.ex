defmodule SportywebWeb.RentalRuleLive.Index do
  ...
  defp apply_action(socket, :index, %{"club_id" => club_id}) do
    club = Organization.get_club!(club_id, rental_rules: [:category, :article], articles: [], categories: [])

    socket
    |> assign(:page_title, "Mietregeln")
    |> assign(:all_rental_rules, club.rental_rules)
    |> assign(:club, club)
    |> assign(:scope, "")
    |> assign(:object_id, "")
    |> stream(:rental_rules, club.rental_rules, reset: true)
  end
end
