        ...
        >
          <.input_grids>
            ...
            <.input_grid class="pt-6">
              ...
              <div class="col-span-12 md:col-span-6">
                <.input field={@form[:for_non_members]} type="checkbox" label="Für Nichtmitglieder" />
              </div>
            </.input_grid>
            ...
            <.input_grid class="pt-6">
              ...
              <%= if @form[:rental_period_unit].value == "Saison" do %>
                <div class="col-span-12 md:col-span-6">
                  <.input field={@form[:season_start_date]} type="date" label="Startdatum der Saison" />
                </div>

                <div class="col-span-12 md:col-span-6">
                  <.input field={@form[:season_end_date]} type="date" label="Enddatum der Saison" />
                </div>
              <% end %>
                  ...
                  <%= case @form[:rental_period_unit].value do %>
                    <% "Stunden" -> %>
                      <.input
                        ...
                        prompt="Bitte auswählen"
                        options={
                          Enum.map(1..12, &{"#{&1} Stunde#{if &1 == 1, do: "", else: "n"}", &1})
                        }
                      />
                    <% "Tage" -> %>
                      <.input
                    ...
                    <% "Wochen" -> %>
                      <.input
                        ...
                        prompt="Bitte auswählen"
                        options={
                          Enum.map(1..10, &{"#{&1} Woche#{if &1 == 1, do: "", else: "n"}", &1})
                        }
                      />
                    <% _ -> %>
                      <div></div>
          ...
          <:actions>
            ...
            <.button
              ...
              phx-click={JS.push("archive", value: %{id: @rental_rule.id})}
